...
public class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<?>> SUMMON_BENCH = BLOCK_ENTITY_TYPE.register("summon_bench", () -> BlockEntityType.Builder.of(SummonBenchBlockEntity::new, BlockInit.SUMMON_BENCH.get()).build(null));
